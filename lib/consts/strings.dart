const appname = "crafty bay";
const appversion = "Version 1.0.0";
const credits = "@crafty bay";
const email = "Email";
...
const createNewAccunt = "create New Account";
const privacyPolicy = "Privacy Policy";
const loggedin ="Logged in successfully";
const loggedout ="Logged out successfully";
const picep= "Please enter a valid email address and password";
const termAndCond = "Terms And Conditions";
const allreadyHaveAccount = "Already have an account?";
...
const video = "Video",
    ...
    productsYMlike = "Products you may also like ";
